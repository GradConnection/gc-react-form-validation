...
class GCInputSVG extends Component {
  render() {
    ...
    switch (type) {
      case 'chevronDown':
      return (
        <svg id="layer_chevronDown" className={className} viewBox="0 0 100 100" onClick={e => this.props.onClick(e)}>
          <title id={type}>
            {type}
          </title>
      ...
      case 'chevronUp':
      return (
        <svg id="layer_chevronUp" className={className} viewBox="0 0 100 100" onClick={e => this.props.onClick(e)}>
          <title id={type}>
            {type}
          </title>
