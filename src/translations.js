const translationDefaults = {
  ...
  dateRange: (fromDate, toDate) =>
    `Choose a date between ${fromDate.toDateString()} and ${toDate.toDateString()}`,
  maxDate: toDate => `Choose a date earlier than ${toDate}`,
  minDate: fromDate => `Choose a date later than ${fromDate}`,
  timeRange: (fromTime, toTime) =>
    `Choose a time between ${fromTime} and ${toTime}`,
