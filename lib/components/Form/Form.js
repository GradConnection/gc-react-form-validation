...
var Form = function (_Component) {
  ...
  _createClass(Form, [{
    ...
    value: function submitForm(e) {
      ...
      e.preventDefault();
      e.stopPropagation();
      console.log('ERROR OBJ: ', this.state.errorObj);
      console.log('DATA OBJ: ', this.props.data);
      console.log('ALLOW SUB: ', this.allowSubmission(this.state.errorObj, this.props.data));
    ...
    value: function validateForm(name, results) {
      ...
      this.setState({ errorObj: copiedObj }, function () {
        _this5.props.disableSubmitButton(_this5.allowSubmission(copiedObj, _this5.props.data));
      });
    }
  }, {
    key: 'render',
