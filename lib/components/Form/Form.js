...
var Form = function (_Component) {
  ...
  _createClass(Form, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (!prevState.formSubmitted && this.state.formSubmitted) {
        if (this.state.errorObj.length > 0) {
          ...
          this.setState({
            errorMessage: (0, _isEmpty2.default)(this.props.submissionErrorMessages) ? '' : this.props.submissionErrorMessages
          });
        } else {
          this.setState({
            errorObj: {},
    ...
    value: function getFields() {
      ...
      return (0, _mapValues2.default)(this.props.data, function (d) {
        return _react2.default.createElement(_Input2.default, _extends({}, d, {
          ...
          onChange: _this2.props.handleInputChange,
          touchedByParent: _this2.state.formSubmitted,
          sendResultsToForm: function sendResultsToForm(r) {
            return _this2.validateForm(r);
          }
        }));
      });
    }
    ...
    key: 'validateForm',
    value: function validateForm(results, name) {
      var newError = this.state.errorObj;
      if (results && (0, _has2.default)(newError, name)) {
        newError[name] = results;
        this.setState({ errorObj: newError });
      } else if (!results && (0, _has2.default)(newError, name)) {
