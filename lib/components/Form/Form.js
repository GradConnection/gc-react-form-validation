  ...
  _createClass(Form, [{
    ...
    value: function hasRequiredFields(data) {
      ...
      var requiredFields = Object.keys(data).filter(function (d) {
        return (0, _has2.default)(data[d], 'required') && (0, _get2.default)(data[d], 'required') && (0, _has2.default)(data[d], 'isVisible') && (0, _get2.default)(data[d], 'isVisible') && condition(d) || (0, _has2.default)(data[d], 'required') && (0, _get2.default)(data[d], 'required') && !(0, _has2.default)(data[d], 'isVisible') && condition(d);
      });
        ...
        if ((0, _isArray2.default)(this.props.submissionErrorMessages)) {
          ...
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              'p',
              null,
              (0, _reactHtmlParser2.default)(this.props.submissionErrorMessages)
            )
          );
        }
      }
    ...
    value: function submitForm(e) {
      ...
      if (this.allowSubmission(this.state.errorObj, this.props.data)) {
        ...
        this.setState({
          ...
          if (_this4.props.sendSubmissionValidationErrors) {
...
Form.propTypes = {
  ...
  handleFormErrors: _propTypes2.default.func,
  sendSubmissionValidationErrors: _propTypes2.default.bool // For troubleshooting
};
