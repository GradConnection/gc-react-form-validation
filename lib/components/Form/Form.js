...
var Form = function (_Component) {
  ...
  _createClass(Form, [{
    ...
    value: function submitForm(e) {
      ...
      setTimeout(function () {
        var dataKeys = Object.keys(_this3.props.data);
        if (GCFormCounter === dataKeys.length) {
          _this3.props.onSubmit();
          _this3.setState({
            errorMessage: (0, _isEmpty2.default)(_this3.props.submissionErrorMessages) ? '' : _this3.props.submissionErrorMessages
          });
        } else {
          _this3.setState({
    ...
    key: 'validateForm',
    value: function validateForm(results) {
      if (results) {
        GCFormCounter++;
      }
    }
