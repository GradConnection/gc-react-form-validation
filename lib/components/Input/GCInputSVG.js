      ...
      switch (type) {
        case 'chevronDown':
          return _react2.default.createElement(
            'svg',
            { id: 'layer_chevronDown', className: className, style: { maxHeight: '60px' }, viewBox: '0 0 100 100', onClick: function onClick(e) {
        ...
        case 'chevronUp':
          return _react2.default.createElement(
            'svg',
            { id: 'layer_chevronUp', className: className, style: { maxHeight: '60px' }, viewBox: '0 0 100 100', onClick: function onClick(e) {
                return _this2.props.onClick(e);
              } },
            _react2.default.createElement(
              'title',
