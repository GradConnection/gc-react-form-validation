...
var Input = function (_Component) {
  ...
  _createClass(Input, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      return nextProps.value !== this.props.value || nextProps.isVisible != this.props.isVisible || nextState.validationMessage !== this.state.validationMessage || nextProps.options !== this.props.options || this.state.tooltip !== nextState.tooltip || this.props.formSubmitted !== nextProps.formSubmitted;
    }
  }, {
    key: 'componentDidUpdate',
    value: function componentDidUpdate(prevProps) {
      if (prevProps.value !== this.props.value && this.props.hidden || prevProps.value !== this.props.value && this.props.customUI || !prevProps.formSubmitted && this.props.formSubmitted) {
        this.validateInput();
      }
    }
  }, {
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(_GCInputRenderer2.default, _extends({
                validateInput: function validateInput(open) {
                  return _this2.validateInput(open);
                },
...
}, _defineProperty(_Input$propTypes, 'tooltip', _propTypes2.default.string), _defineProperty(_Input$propTypes, 'customUI', _propTypes2.default.bool), _defineProperty(_Input$propTypes, 'formSubmitted', _propTypes2.default.bool), _defineProperty(_Input$propTypes, 'customComponent', _propTypes2.default.func), _Input$propTypes);
...
Input.defaultProps = (_Input$defaultProps = {
  ...
  loading: false,
  hidden: false
}, _defineProperty(_Input$defaultProps, 'tooltip', ''), _defineProperty(_Input$defaultProps, 'customUI', false), _defineProperty(_Input$defaultProps, 'formSubmitted', false), _defineProperty(_Input$defaultProps, 'customComponent', null), _Input$defaultProps);
