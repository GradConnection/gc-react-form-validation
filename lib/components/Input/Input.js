...
var Input = function (_Component) {
  ...
  _createClass(Input, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      return nextProps.value !== this.props.value || nextProps.title !== this.props.title || nextProps.isVisible != this.props.isVisible || nextState.validationMessage !== this.state.validationMessage || nextProps.options !== this.props.options || this.state.tooltip !== nextState.tooltip || this.props.formSubmitted !== nextProps.formSubmitted || this.props.disabled !== nextProps.disabled || this.props.translations !== nextProps.translations;
    }
  }, {
    ...
    value: async function handleInputValidation(open) {
      ...
      var validationState = await (0, _validateInput2.default)(validationObj, this.props.translations);
      ...
      if (this.props.isVisible) {
        if (this.props.customUI) {
          ...
          return _react2.default.createElement(
            'div',
            {
              className: 'gc-input gc-input--' + this.props.type + ' ' + this.props.extendedClassNames + ' ' + (checkboxSingle ? 'gc-input--checkbox-single' : '') + ' ' + (this.props.description !== '' ? 'gc-input--has-description' : '')
            },
...
}, _defineProperty(_Input$propTypes, 'tooltip', _propTypes2.default.string), _defineProperty(_Input$propTypes, 'customUI', _propTypes2.default.bool), _defineProperty(_Input$propTypes, 'formSubmitted', _propTypes2.default.bool), _defineProperty(_Input$propTypes, 'customComponent', _propTypes2.default.func), _defineProperty(_Input$propTypes, 'defaultAll', _propTypes2.default.bool), _defineProperty(_Input$propTypes, 'defaultText', _propTypes2.default.string), _defineProperty(_Input$propTypes, 'translations', _propTypes2.default.object), _Input$propTypes);
