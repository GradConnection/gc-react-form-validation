...
Input.defaultProps = (_Input$defaultProps = {
  ...
  loading: false,
  hidden: false
}, _defineProperty(_Input$defaultProps, 'tooltip', ''), _defineProperty(_Input$defaultProps, 'customUI', false), _defineProperty(_Input$defaultProps, 'formSubmitted', false), _defineProperty(_Input$defaultProps, 'customComponent', null), _defineProperty(_Input$defaultProps, 'defaultText', 'All Options'), _defineProperty(_Input$defaultProps, 'defaultAll', false), _Input$defaultProps);
