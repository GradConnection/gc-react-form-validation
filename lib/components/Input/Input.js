      ...
      if (this.props.isVisible) {
        if (this.props.customUI) {
          return _react2.default.createElement(
            'div',
            {
              className: 'gc-input gc-input--custom ' + this.props.extendedClassNames
            },
...
}, _defineProperty(_Input$propTypes, 'tooltip', _propTypes2.default.string), _defineProperty(_Input$propTypes, 'customUI', _propTypes2.default.bool), _defineProperty(_Input$propTypes, 'formSubmitted', _propTypes2.default.bool), _Input$propTypes);
...
Input.defaultProps = (_Input$defaultProps = {
  ...
  loading: false,
  hidden: false
}, _defineProperty(_Input$defaultProps, 'tooltip', ''), _defineProperty(_Input$defaultProps, 'customUI', false), _defineProperty(_Input$defaultProps, 'formSubmitted', false), _Input$defaultProps);
