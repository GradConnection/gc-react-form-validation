...
var GCMultiSelect = function (_Component) {
  ...
  function GCMultiSelect(props) {
    ...
    _this.state = {
      ...
      reworkedOptions: _this.generateOptions(_this.props.options),
  ...
  _createClass(GCMultiSelect, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (nextProps.options !== this.props.options) {
        this.setState({
          reworkedOptions: this.generateOptions(nextProps.options)
        });
      }
    }
  }, {
    ...
    value: function getSearchResults() {
      ...
      var options = this.getInactiveItems(this.state.reworkedOptions);
      if (searchTxt === '') {
        return options;
      }
      ...
      return _react2.default.createElement(
        ...
        !this.props.loading && _react2.default.createElement(
          ...
          this.props.accordian && _react2.default.createElement(
            ...
            this.renderActiveItems(this.state.reworkedOptions),
...
GCMultiSelect.propTypes = {
  ...
  defaultNone: _propTypes2.default.bool,
  defaultNoneLabel: _propTypes2.default.string
};
