  ...
  _createClass(GCMultiSelect, [{
    ...
    value: function renderActiveItems(options) {
      ...
      return sortedArray.map(function (opt, index) {
        ...
        }, opt.label), _react.default.createElement("div", {
    ...
    value: function getSearchResults() {
      ...
      var foo = (0, _filter.default)(options, function (o) {
    ...
    value: function getValue(arr, value) {
      var valueArray = (0, _isArray.default)(value) ? value : value.split(', ');
      var objArray = [];
    ...
    value: function deleteFromArray(value) {
      var newValueArray = (0, _without.default)(this.props.value, value);
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        htmlFor: this.props.name
      }, this.props.title), this.props.value.length > 0 && _react.default.createElement("div", {
        className: "gc-select__option-count"
      }, _react.default.createElement("span", {
        className: "gc-select__option-count--text"
      }, this.props.value.length), _react.default.createElement("div", {
        className: "gc-select__cross",
        onMouseDown: function onMouseDown() {
          return _this9.removeAll();
        }
      })), this.props.loading ? this.props.spinner : _react.default.createElement(_react.Fragment, null, this.state.isActive ? _react.default.createElement(_GCInputSVG.default, {
        type: "chevronUp",
        onMouseDown: function onMouseDown(e) {
        ...
        className: "gc-select__input-icon gc-multi-select__icon"
      }))), !this.props.loading && _react.default.createElement(_react.Fragment, null, this.props.accordian && _react.default.createElement("ul", {
      ...
      })), this.renderActiveItems(this.reworkedOptions), this.renderOtherItems(this.props.options)), this.state.isActive && !this.props.accordian && _react.default.createElement("ul", {
...
exports.GCMultiSelect = GCMultiSelect;
GCMultiSelect.propTypes = {
  ...
  accordian: _propTypes.default.bool,
  loading: _propTypes.default.bool,
  disabled: _propTypes.default.bool,
  spinner: _propTypes.default.node,
  defaultNone: _propTypes.default.bool,
  defaultNoneLabel: _propTypes.default.string
};
